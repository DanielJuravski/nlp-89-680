            ...
            for prev_tag in tag_set:
                ...
                for prev_prev_tag in tag_set:
                    ...
                    if first_prediction_for_tag:
                        ...
                        new_prev_id = feature_to_id.get(ExtractFeatures.get_feat_str_by_prevtag(prev_tag), None)
                    ...
                    old_prev_id = feature_to_id.get(ExtractFeatures.get_feat_str_by_prevtag(prev_tag), None)
                    old_2prevs_id = feature_to_id.get(ExtractFeatures
